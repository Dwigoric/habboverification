...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			COMMAND_INVITE: () => [
				'Code of this bot is licensed under GNU Affero General Public License v2.0. Bots which have this code must be private and not be public.'
			],
			COMMAND_INVITE_DESCRIPTION: 'Displays the invite link of the bot, to invite it to your guild.',
			COMMAND_INFO: [
				'This is a simple Habbo verification bot. All code modifications are permitted under GNU AGPL v2.0.'
			],
